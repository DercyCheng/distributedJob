...
const (
	...
	UserService_AssignUserRoles_FullMethodName = "/api.grpc.UserService/AssignUserRoles"
)
...
func (c *aISchedulerServiceClient) AnalyzeJob(ctx context.Context, in *AnalyzeJobRequest, opts ...grpc.CallOption) (*AnalyzeJobResponse, error) {
	...
	err := c.cc.Invoke(ctx, AISchedulerService_AnalyzeJob_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aISchedulerServiceClient) OptimizeSchedule(ctx context.Context, in *OptimizeScheduleRequest, opts ...grpc.CallOption) (*OptimizeScheduleResponse, error) {
	...
	err := c.cc.Invoke(ctx, AISchedulerService_OptimizeSchedule_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *aISchedulerServiceClient) GetAIRecommendations(ctx context.Context, in *GetAIRecommendationsRequest, opts ...grpc.CallOption) (*GetAIRecommendationsResponse, error) {
	...
	err := c.cc.Invoke(ctx, AISchedulerService_GetAIRecommendations_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedAISchedulerServiceServer must be embedded to have
// forward compatible implementations.
//
// NOTE: this should be embedded by value instead of pointer to avoid a nil
// pointer dereference when methods are called.
...
func (UnimplementedAISchedulerServiceServer) testEmbeddedByValue()                            {}
...
func RegisterAISchedulerServiceServer(s grpc.ServiceRegistrar, srv AISchedulerServiceServer) {
	// If the following call pancis, it indicates UnimplementedAISchedulerServiceServer was
	// embedded by pointer and is nil.  This will cause panics if an
	// unimplemented method is ever invoked, so we test this at initialization
	// time to prevent it from happening at runtime later due to I/O.
	if t, ok := srv.(interface{ testEmbeddedByValue() }); ok {
...
func (c *mCPServiceClient) GetResources(ctx context.Context, in *GetResourcesRequest, opts ...grpc.CallOption) (*GetResourcesResponse, error) {
	...
	err := c.cc.Invoke(ctx, MCPService_GetResources_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil

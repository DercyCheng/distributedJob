...
type AuthServiceClient interface {
	...
	GetUserPermissions(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*PermissionsResponse, error)
}
...
func (c *authServiceClient) GetUserPermissions(ctx context.Context, in *UserRequest, opts ...grpc.CallOption) (*PermissionsResponse, error) {
...
type AuthServiceServer interface {
	...
	GetUserPermissions(context.Context, *UserRequest) (*PermissionsResponse, error)
...
func (UnimplementedAuthServiceServer) GetUserPermissions(context.Context, *UserRequest) (*PermissionsResponse, error) {
...
func _AuthService_GetUserPermissions_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(AuthServiceServer).GetUserPermissions(ctx, req.(*UserRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var AuthService_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "internal/rpc/proto/auth.proto",
}
